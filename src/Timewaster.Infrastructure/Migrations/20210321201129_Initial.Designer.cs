...
namespace Timewaster.Infrastructure.Migrations
{
    ...
    [Migration("20210321201129_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Timewaster.Core.Entities.Accounts.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Timewaster.Core.Entities.Accounts.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:HiLoSequenceName", "team")
            ...
            modelBuilder.Entity("TeamUser", b =>
                {
                    b.HasOne("Timewaster.Core.Entities.Accounts.Team", null)
                        .WithMany()
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Timewaster.Core.Entities.Accounts.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Timewaster.Core.Entities.Accounts.User", b =>
                {
                    b.HasOne("Timewaster.Core.Entities.Accounts.ApplicationUser", "ApplicationUser")
                        .WithMany()
